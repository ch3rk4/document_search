# Generated by Django 4.2.7 on 2025-08-08 14:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("file_path", models.FileField(blank=True, null=True, upload_to="documents/", verbose_name="Файл")),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Дата создания")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="doc_storage.document", verbose_name="Документ"
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(fields=["document", "query"], name="doc_storage_documen_bf5364_idx"),
                    models.Index(fields=["matched_word"], name="doc_storage_matched_f134c6_idx"),
                    models.Index(fields=["position"], name="doc_storage_positio_94b825_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["query"], name="doc_storage_query_381a55_idx"),
                    models.Index(fields=["document"], name="doc_storage_documen_a4cbcf_idx"),
                    models.Index(fields=["created_at"], name="doc_storage_created_120848_idx"),
                    models.Index(fields=["user"], name="doc_storage_user_id_87d63c_idx"),
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            model_name="document",
            index=models.Index(fields=["created_at"], name="doc_storage_created_820a36_idx"),
        ),
        migrations.AddIndex(
            model_name="document",
            index=models.Index(fields=["category"], name="doc_storage_categor_3ee17b_idx"),
        ),
        migrations.AddIndex(
            model_name="document",
            index=models.Index(fields=["author"], name="doc_storage_author__cc083b_idx"),
        ),
    ]
