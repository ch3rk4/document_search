...
class DocumentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Статистика', {
            'fields': ('word_count', 'search_count', 'created_at', 'updated_at'),
            'classes': ('collapse',)
        }),
    )
...
class WordMatchAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Основная информация', {
            'fields': ('document', 'query', 'matched_word')
        }),
        ('Детали совпадения', {
            'fields': ('match_type', 'position', 'relevance_score')
        }),
        ('Контекст', {
...
class SearchHistoryAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'query', 'document', 'user', 'results_count', 'search_time',
    ...
    fieldsets = (
        ('Поисковый запрос', {
            'fields': ('query', 'document', 'user')
        }),
        ('Результаты', {
            'fields': ('results_count', 'search_time')
        }),
        ('Метаданные', {
